...
| 层次 | 名称 | 法律隐喻 | 说明 |
|------|------|----------|------|
| Paper | 工作论文 | 立法原理 | 系统总结归纳基本原理与方法论 |
| Usecase | 工作案例 | 精选判例 | 来源于具体实践案例的积累与复用 |
| Handbook | 工作手册 | 权威法理 | 来源于人与工具/人协作时的经验总结 |
| Specification | 工程标准 | 程序性法律 | 对人机协作进行明确约束与规范 |
| Bylaws | 工作章程 | 宪法 | 规定基本原则与权责划分 |
